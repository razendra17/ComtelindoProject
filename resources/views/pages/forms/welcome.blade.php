...
<div class="bg-white py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:text-center">
            <a href="#"
                class="inline-block bg-[#DE5727] text-white font-semibold text-sm px-4 py-2 rounded-lg hover:bg-[#c94e1f] transition duration-200">
                Submit Form
            </a>
            <p class="mt-2 text-4xl font-semibold tracking-tight text-pretty text-[#ED9720] sm:text-5xl lg:text-balance">
                Your One Stop IT Solutions</p>
            <p class="mt-6 text-lg/8 text-[#ED9720]">Solusi IT satu atap untuk mendukung bisnis Anda dengan layanan
                internet berkualitas, pengembangan software inovatif, dan infrastruktur jaringan yang terpercaya.</p>
        </div>
        <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                ...
                <div class="relative pl-16">
                    ...
                    <dd class="mt-2 text-base/7 text-gray-400">Arcu egestas dolor vel iaculis in ipsum mauris. Tincidunt
