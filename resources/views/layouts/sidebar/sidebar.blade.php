...
<div id="drawer-navigation"
    ...
    <div class="border-b border-default pb-4 flex items-center">
        <span class="self-center text-lg font-semibold whitespace-nowrap text-body">Admin Panel</span>
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <button type="button"
                    ...
                    <svg class="shrink-0 w-5 h-5 transition duration-75 group-hover:text-[#eb8e23]" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                        viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li>
                        <a href="#"
                            class="pl-10 flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-[#eb8e23]">Cities</a>
                    </li>
                    <li>
                        <a href="#"
                            class="pl-10 flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-[#eb8e23]">Package</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a href="#"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Upcoming Request</span>
                    <span
                        class="inline-flex items-center justify-center w-4.5 h-4.5 ms-2 text-xs font-medium text-fg-danger-strong bg-danger-soft border border-danger-subtle rounded-full">!</span>
                </a>
            </li>
            <li>
                <a href="#"
